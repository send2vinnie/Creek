...
namespace Vestris.ResourceLib
{
    ...
    public abstract class Resource
    {
        ...
        {
            IntPtr h;
            if (ResourceInfo.duringBatchUpdate && ResourceInfo.fileBatchUpdate == filename)
            {
                h = ResourceInfo.handlerBatchUpdate;
            }
            else
            {
                h = Kernel32.BeginUpdateResource(filename, false);
            }
            ...
            if (h != ResourceInfo.handlerBatchUpdate)
            {
